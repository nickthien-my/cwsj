                ...
                <Row>
                    <Col lg={4} className="pb-4">
                        <Row xs="auto" className="pb-3">
                            ...
                            <div>
                                <a href="https://www.instagram.com/care.warriors/">
                            ...
                            <div>
                                <a href="https://www.youtube.com/channel/UCXCQpB-_BWaSS0WN488Z69w/">
                        ...
                        <Row>
                            <small className="d-block mb-3 text-muted">&copy; {new Date().getFullYear()} Care Warriors Association</small>
                        </Row>
                        <Row>
