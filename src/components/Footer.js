...
const socMedLinks = [
    {
        ...
        url: "https://www.facebook.com/CareWarriorsAssociation",
    ...
    },
    {
        ...
        url: "https://www.instagram.com/care.warriors",
    ...
    {
        class: "bi bi-youtube",
        url: "https://www.youtube.com/channel/UCXCQpB-_BWaSS0WN488Z69w",
...
export default function Footer() {
    return (
        <div className="container-fluid mt-5 pt-3 bg-light">
            <div className="row justify-content-center">
                <div className="col-lg-3 offset-lg-1 pb-4">
                    <h4>Follow us on:</h4>
                        ...
                        {socMedLinks.map(link => (
                            <React.Fragment key={link.url}>
                                <div className="col-2 align-self-center">
                                    <a href={link.url}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="50" fill="currentColor" className={link.class} viewBox="0 0 16 16">
                                            <path d={link.path} />
                                        </svg>
                                    </a>
                                </div>
                    ...
                    <small className="d-block pb-3 text-muted">&copy; {new Date().getFullYear()} Care Warriors Association</small>

                    <small className="d-block pb-3 text-muted">Website developed by <a href="https://www.nickthien.com">Nicholas Thien</a></small>
